...
const CASE_STUDIES: CaseStudy[] = [
  {
    ...
    client: 'DripGather',
    industry: 'E-commerce',
    before: { traffic: 1200, conversion: 1.2, revenue: 15000 },
    after: { traffic: 8500, conversion: 2.8, revenue: 85000 },
    description: 'AI-powered e-commerce platform with intelligent product discovery and premium shopping experience.',
    duration: '4 months',
    services: ['Web Dev', 'AI Integration', 'E-commerce'],
  },
  {
    id: 'promptlyos',
    client: 'PromptlyOS',
    industry: 'SaaS',
    before: { traffic: 800, conversion: 1.5, revenue: 5000 },
    after: { traffic: 4200, conversion: 3.2, revenue: 45000 },
    description: 'AI-powered career tracking dashboard with 4 specialized role dashboards for developers, freelancers, managers, and recruiters.',
    duration: '3 months',
